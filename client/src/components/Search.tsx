    ...
    <div className="flex flex-wrap -mx-4 overflow-hidden">
      <div className="my-2 px-3">
        <div className="shadow flex">
          <input onChange={(e) => setInput(e.target.value)} onKeyPress={onKeyPress} className="w-300 rounded p-2 border-1 border-gray-400" type="text" value={input} id="grid-password" placeholder="Search..." />
